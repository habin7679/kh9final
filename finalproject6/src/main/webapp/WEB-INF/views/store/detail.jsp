...
<main class="container">
  <div class="p-4 p-md-5 mb-4 rounded text-bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">맛으로 승부합니다</h1>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        ...
        <div class="col-auto d-none d-lg-block">
          <img src="${pageContext.request.contextPath}${storeImgUrl}" width="140" height="170"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
...
<script>console.log('First Script');</script><style>.Test { background-color: black; }</style></body>
    			...
    			<table border=1 style='font-size:12pt' class="table">
    				...
    				<tr align='center'>
    					...
    					<c:if test="${sellerNo eq sellerNo2}">
                           ...
                           <a href="${pageContext.request.contextPath}/store/edit?storeNo=${storeDto.storeNo}" class="btn btn primary">내가게수정</a>
                           </c:if>
